...
// Loads INI file
void INIReader::LoadFile(const char* filename)
{
	this->ClearLoadedData();
	_error = ini_parse(filename, ValueHandler, this);
}

// Loads INI file from string
void INIReader::LoadINIfromString(const char* str)
{
	this->ClearLoadedData();
	_error = ini_parse_string(str, ValueHandler, this);
}

// Clear
void INIReader::ClearLoadedData()
{
	this->_values.clear();
}
